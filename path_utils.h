#ifndef MIMUW_FORK__PATH_UTILS_H_
#define MIMUW_FORK__PATH_UTILS_H_
...
// Valid paths are '/'-separated sequences of folder names, always starting and
// ending with '/'. Valid paths have length at most MAX_PATH_LENGTH (and at
// least 1). Valid folder names are are sequences of 'a'-'z' ASCII characters,
...
//    Then the first component will be copied there (without any '/'
//    characters).
